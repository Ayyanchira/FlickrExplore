...
//
//   let photoInfo = try? newJSONDecoder().decode(PhotoInfo.self, from: jsonData)
//
// To parse values from Alamofire responses:
//
//   Alamofire.request(url).responsePhotoInfo { response in
...
//    let posted, taken, takengranularity, takenunknown: String
...
//
//struct Note: Codable {
//    let id, photoID: String
//    let author: Nsid
//    let authorname: Rname
//    let authorrealname: String
//    let authorispro, authorisdeleted: Int
//    let x, y, w, h: String
//    let content, proBadge: String
//
//    enum CodingKeys: String, CodingKey {
//        case id
//        case photoID = "photo_id"
//        case author, authorname, authorrealname, authorispro, authorisdeleted, x, y, w, h
//        case content = "_content"
...
//    case the8740272N04 = "8740272@N04"
//}
//
//enum Rname: String, Codable {
//    case xenaBestFriend = "Xena*best friend*"
//}
//
...
//
//    @discardableResult
//    func responsePhotoInfo(queue: DispatchQueue? = nil, completionHandler: @escaping (DataResponse<PhotoInfo>) -> Void) -> Self {
...
struct PhotoDetail: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, secret, server, farm, dateuploaded, isfavorite, license
        case safetyLevel = "safety_level"
        case rotation, originalsecret, originalformat, owner, title, description, visibility, dates, views, editability, publiceditability, usage, comments, notes, people, tags, urls, media
    }
}
